...
<div>
					...
					<div class="ten wide column">
						<div class="ui raised segment" :class="{ loading: show_loading }" v-if="!show_success">
    						...
    						<div v-if="include_pairing">
								<div class="field" :class="{ error: errors.has('left_points') }">
									...
									<input
										...
										v-validate="{ numeric: true, max_value:left_points, min_value:200 }"
								...
								<div class="field" :class="{ error: errors.has('right_points') }">
									...
									<input
										...
										v-validate="{ numeric: true, max_value:right_points, min_value:200 }"
    						...
    						<div v-if="include_referral">
								<div class="field" :class="{ error: errors.has('referral_points') }">
									...
									<input
										...
										v-validate="{ numeric: true, max_value:referral_points, min_value:100 }"
							...
							<div class="field">
								...
								<button
									class="ui large fluid green button"
								...
								<button
									class="ui large fluid green disabled button"
									v-else
								>
									 Submit Cash Out Request
								</button>
	...
	<div class="ui cashout-pairing-modal modal mini">
		...
		<div class="actions">
			...
			<div class="ui orange button" @click.prevent.stop="cashoutPoints" v-if="validPointsToCashout">Confirm Cash Out</div>
		...
		computed: {
			...
			validPointsToCashout() {
					...
					if (this.include_referral == true && this.include_pairing == true) {
						if (parseInt(this.cashout.left_points) >= 200 && parseInt(this.cashout.right_points) >= 200 && parseInt(this.cashout.referral_points) >= 100 && parseInt(this.left_points) >= 200 && parseInt(this.right_points) >= 200 && parseInt(this.referral_points) >= 100 && parseInt(this.cashout.left_points) <= 1200 && parseInt(this.cashout.right_points) <= 1200) {
						...
						if (parseInt(this.cashout.left_points) >= 200 && parseInt(this.cashout.right_points) >= 200 && parseInt(this.left_points) >= 200 && parseInt(this.right_points) >= 200 && parseInt(this.cashout.left_points) <= 1200 && parseInt(this.cashout.right_points) <= 1200) {
							return true;
						} else {
							return false;
						}
